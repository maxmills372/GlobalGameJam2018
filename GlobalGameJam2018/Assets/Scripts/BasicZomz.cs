...
public class BasicZomz : MonoBehaviour 
{
	...
	void CrowdControl()
	{
		foreach (GameObject obj in nearby_zombz)
		{
			...
			// EXPLOSIONS!!!!!!!!!!!!!!
			GetComponent<Rigidbody> ().AddExplosionForce (10.0f, force, comfort_zone);
		}

		//GetComponent<Rigidbody> ().AddExplosionForce (20.0f, player_location.transform.position, min_distance);
	}
